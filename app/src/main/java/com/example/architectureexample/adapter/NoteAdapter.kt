...
class NoteAdapter : ListAdapter<Note, NoteAdapter.NoteHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: NoteHolder, position: Int) {
        ...
        holder.textViewDescription.text = currentNote.desc
    }
    ...
    inner class NoteHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var textViewTitle: TextView = itemView.txt_view_title
        var textViewPriority: TextView = itemView.text_view_priority
        var textViewDescription: TextView = itemView.txt_view_desc
    }
